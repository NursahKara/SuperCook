            ...
            <ScrollView>
              ...
              <View style={{alignItems:'flex-start',justifyContent:'center',marginTop:'12%',flex:1}}>
                ...
                <View style={{justifyContent:'center',alignItems:'center',marginTop:'12%',flex:4}}>
                  <Text style={styles.textStyle}>Favoriler</Text>
                </View>
                <TouchableOpacity style={{alignItems:'flex-end',justifyContent:'center',marginTop:'12%',flex:1,marginRight:23}}>
                <Image source={require('../../assest/images/moree.png')} style={styles.menuImage} />
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.body}>
                <View style={{marginLeft:20,marginRight:20}}>
                  <View style={{justifyContent:'center',alignItems:"center",marginTop:'10%',}}>
                    <Image source={require('../../assest/images/yemek.png')} style={styles.imageView} />
                    <Text style={{fontSize:15,textAlign:'center',marginTop:'5%',opacity:0.5}}>Sadece giriş yapmış </Text>
                    <Text style={{fontSize:15,textAlign:'center',opacity:0.5}}>kullanıcılar </Text>
                    <Text style={{fontSize:15,textAlign:'center',opacity:0.5}}>favorilere ekleyebilir.</Text>
                  </View>                
